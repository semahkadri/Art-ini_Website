<?php 
    ...
    if( isset($_POST["desc_pro"])&& isset($_POST["nom"]) && isset($_POST["valeur"]) ) {
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                        <li><a href="forms_inf.php">Ajouter un evenement</a></li>
                        <li><a href="forms_spons.php">Ajouter un promotion</a></li>
        ...
        <div class="page-content">
            ...
            <div class="page-header no-margin-bottom">
                <div class="container-fluid">
                    <h2 class="h5 no-margin-bottom">Ajouter un promotion</h2>
                </div>
            </div>
            <!-- Breadcrumb-->
            <div class="container-fluid">
