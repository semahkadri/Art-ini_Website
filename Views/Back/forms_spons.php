        ...
        <div class="page-content">
            ...
            <div class="page-header no-margin-bottom">
                <div class="container-fluid">
                    <h2 class="h5 no-margin-bottom">Ajouter un sponsor</h2>
                </div>
            </div>
            <!-- Breadcrumb-->
            <div class="container-fluid">
            ...
            <section class="no-padding-top">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="block">
                                <div class="title"><strong class="d-block">Ajouter sponsor</strong><span class="d-block">veuillez ajouter un nouveau sponsor</span></div>
                                <div class="block-body">
                                    <form name ="f" class="form-horizontal" method="POST">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="nom_sponsor" id="nom_sponsor" placeholder="nom du sponsor" minlength="4" style="width:350px" class="form-control form-control-success" required><small class="form-text">Art-ini </small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="historique_sponsor" id="historique_sponsor" placeholder="historique du sponsor" minlength="4" style="width:350px" class="form-control form-control-success" required><small class="form-text">Art-ini </small>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <input type="file" class="btn btn-primary" name="photo_sponsor" id="photo_sponsor" required></input>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-9 offset-sm-3">
                                                ...
                                                <div id="id" class="modal">
                                                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                                       ...
                                                       <strong> Succés</strong> Tu as ajouté un sponsor.
