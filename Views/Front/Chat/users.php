...
<nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a class="nav-link" href="http://localhost/demo/Semah/Viewer/Front/info.php">Categories</a></li>
                                <li class="nav-item"><a class="nav-link" href="http://localhost/demo/Semah/Viewer/Front/shop.php">Produits</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Evénements</a></li>
                                <li class="nav-item"><a class="nav-link" href="http://localhost/demo/Semah/Viewer/Front/reply.php">Feedbacks</a></li>
