        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
            <div class="container-fluid">
                <div class="d-flex align-items-center">
                    <a class="navbar-brand py-3" href="index.html" style="line-height: 0;"><img src="Assets/img/most.svg" width="138" height="31" viewBox="50 0 13800 31" fill="none" xmlns="http://www.w3.org/2000/svg"></svg>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <form class="form-inline mt-4 mb-2 d-sm-none" action="#" id="searchcollapsed">
                        <div class="input-label-absolute input-label-absolute-left input-reset w-100">
                            ...
                            <input class="form-control form-control-sm border-0 shadow-0 bg-gray-200" id="searchcollapsed_search" placeholder="Checher" aria-label="Search">
                            <button class="btn btn-reset btn-sm" type="reset"><i class="fa-times fas">           </i></button>
                        </div>
                    </form>
                    <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link" href="index-1.php">Accueil</a></li></li>
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle " id="docsDropdownMenuLink" href="index.php" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Mon Compte</a>
                                   <div class="dropdown-menu dropdown-menu-right" aria-labelledby="docsDropdownMenuLink">
                                       <a class="dropdown-item" href="user-account.php">Mes informations </a><a class="dropdown-item" href="logout.php">Se déconnecter </a>
                                   </div>
                               </li>
