      ...
      <header class="header">
                    ...
                    <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
                        <div class="container-fluid">
                            <a class="navbar-brand py-3" href="index.html" style="line-height: 0;"><img src="img/most.svg" width="138" height="31" viewBox="50 0 13800 31" fill="none" xmlns="http://www.w3.org/2000/svg"></svg>
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown ml-lg-3">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdownMenuLink">
                                        <div class="dropdown-divider"></div><a class="dropdown-item" href="index.html"><i class="fas fa-sign-out-alt mr-2 text-muted"></i> Se déconnecter</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" id="userName" class="form-control" placeholder="Nom">
                <input type="email" id="userEmail" class="form-control" placeholder="Adresse Email">
                <input type="password" id="userPassword" class="form-control" placeholder="Mot de passe">
            </div>
            <div class="modal-footer">
                <button class="btn btn-info" id="registerBtn">S'inscrire</button>
...
<div class="modal" id="logInModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="email" id="userLEmail" class="form-control" placeholder="Adresse Email">
                <input type="password" id="userLPassword" class="form-control" placeholder="Mot de passe">
            </div>
            <div class="modal-footer">
                <button class="btn btn-info" id="loginBtn">Connexion</button>
                <button class="btn btn-warning" data-dismiss="modal">Fermer</button>
            </div>
        </div>
    </div>
...
<div class="container" style="margin-top:50px;">
    <div class="row">
        <div class="col-md-12" align="right">
            ...
            if (!$loggedIn)
                echo '
                        <button class="btn btn-primary" data-toggle="modal" data-target="#registerModal">S"inscrire</button>
