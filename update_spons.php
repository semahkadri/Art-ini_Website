<?php 
    ...
    if(isset($_POST["nom"]) && isset($_POST["desc_pro"]) && isset($_POST["valeur"])) {
      $tp= new Type($_POST["desc_pro"],$_POST["nom"],$_POST["valeur"]);
      $newtp= new TypeC();
                  ...
                  <div class="block-body">
                    <form class="form-horizontal" method="POST">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="desc_pro" id="desc_pro" value="<?= $i['desc_pro'] ?>" class="form-control form-control-success" ><small class="form-text">Allez racontez nous l'historique!</small>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <div class="input-group">
                              <div class="input-group-prepend">
                                <img src="<?php echo $i['valeur'] ?>" width="100" height="100">
                                <input type="file" class="btn btn-primary" name="valeur" value="<?php echo $i["valeur"] ?>"  id="valeur" ></input>
                              </div>
                            </div>
                          </div>
                          </div>
