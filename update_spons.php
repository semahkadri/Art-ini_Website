        ...
        <section class="no-padding-top">
          <div class="container">
            ...
            ?>
              ...
              <!-- Horizontal Form-->
                <div class="block">
                  <div class="title"><strong class="d-block">Modifier promotion</strong><span class="d-block">Modifier la promotion de produit</span></div>
                  <div class="block-body">
                    <form name="f" class="form-horizontal" method="POST">
                        ...
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">description promotion</label>
                          <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">valeur de promotion</label>
                          <div class="col-sm-9">
