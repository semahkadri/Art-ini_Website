<?php
include "C:/xampp/htdocs/ilyes/Controller/productsC.php";
$prod=new productsC;
                    ...
                    <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            ...
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item"><a class="nav-link" href="index-1.html">Accueil</a></li>
                                ...
                                <li class="nav-item dropdown ml-lg-3">
                                    <a id="userDropdownMenuLink" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="avatar" src="img/avatar/avatar-6.jpg" alt="Jack London"></a>
