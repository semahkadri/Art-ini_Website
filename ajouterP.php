...
if(isset($_POST['categorie_prod']))      $categorie_prod=$_POST['categorie_prod'];
else      $categorie_prod="";

if(isset($_POST['prix_prod']))      $prix_prod=$_POST['prix_prod'];
else      $prix_prod="";

if(isset($_POST['img_prod']))      $img_prod=$_POST['img_prod'];
else      $img_prod="";

if(isset($_POST['nom_prod']))      $nom_prod=$_POST['nom_prod'];
else      $nom_prod="";

if(empty($categorie_prod) OR empty($prix_prod) OR empty($img_prod) OR empty($nom_prod) )
    {
...
$sql = "INSERT INTO produits(nom_prod,prix_prod,img_prod,categorie_prod)values('$nom_prod','$prix_prod','$img_prod','$categorie_prod')"; 
...
<input type="text" class="form-control form-control-success" name="categorie_prod" placeholder="Categorie du produit" value="" onkeypress="verifierCaracteres(event); return false;" onblur="verifReff(this)" style="width:500px" required="required"> </br>
     
<label style="font-weight: bold"> Nom du produit </label> 
<input type="text" class="form-control form-control-success" name="nom_prod" placeholder="Nom du produit" value="" onblur="verifReff(this)" onkeypress="verifierCaracteres(event); return false;" style="width:500px"> </br>

<label style="font-weight: bold"> Prix dt </label>
<input type="text"  onblur="verifNB(this)" class="form-control form-control-success" name="prix_prod" value="" placeholder="Prix en Dt" style="width:300px" required="required"></br>

<label style="font-weight: bold">Ajouter une photo</label>
</br>
<input type="file" class="btn btn-primary" name="img_prod" required="required"> </br>
	</br>
<input type="submit" value="valider" name="valider" action="produit.php" class="btn btn-primary"> 
