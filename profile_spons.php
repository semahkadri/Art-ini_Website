    ...
    <section class="py-5">
        <?php
          if (isset($_GET['id_inf'])) {
            $sponsor=new InfluC();
            $i=$sponsor->chercherid($_GET['id_inf']); // récupère l'influenceur à afficher de la base
            //foreach($liste as $i) {
        ?>
      <div class="container">
        <div class="row">
          <div class="col-lg-3 mr-lg-auto">
            <div class="card border-0 shadow mb-6 mb-lg-0">
                ...
                <form method="POST">
                  ...
                  <?php
                     if(isset($_POST["follow_button"]) && (!empty($_POST['follow_button']))){
                      ...
                      try { 
                        $sql = "UPDATE sponsor SET nbr_ab_inf = nbr_ab_inf + 1 WHERE id_inf=".$_GET['id_inf'] ;
              ...
              <div class="card-body p-4">
                ...
                <hr>
                <h6><?php echo $i['nom_sponsor'] ?>'s social media</h6>
          ...
          <div class="col-lg-9 pl-lg-5">
            <h1 class="hero-heading mb-0">Hello, I'm <?php echo $i['nom_sponsor'] ?>!</h1>
            <div class="text-block">
              <p> <span class="badge badge-secondary-light">Joined in <?php echo $i['id'] ?></span></p>
              <p class="text-muted"><?php echo $i['historique_sponsor'] ?> </p>
            </div>
            <div class="text-block">
              <h4 class="mb-5"><?php echo $i['nom_sponsor'] ?>'s upcoming projects!</h4>
              <div class="row">
                <!-- place item-->
                ...
                <div class="col-sm-6 col-lg-4 mb-30px hover-animate" data-marker-id="59c0c8e33b1527bfe2abaf92">
                  <div class="card h-100 border-0 shadow">
                    <div class="card-img-top overflow-hidden gradient-overlay"> <img class="img-fluid" src="<?php  echo $ti['photo_sponsor']?>" alt="Modern, Well-Appointed Room"/><a class="tile-link" href="Up_trip_profile.php?id_voy=<?php echo $ti['id'] ?>"></a>
                    ...
                    <div class="card-body d-flex align-items-center">
                      <div class="w-100">
                        ...
                        <div class="d-flex card-subtitle mb-3">
                          <p class="flex-grow-1 mb-0 text-muted text-sm"><?php  echo $ti['nom_sponsor']?> </p>
