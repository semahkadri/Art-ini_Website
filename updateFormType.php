                  ...
                  <div class="block-body">
                    <form class="form-horizontal" method="POST">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="nom_categorie" id="nom_categorie" value="<?= $i['nom_categorie'] ?>" class="form-control form-control-success" ><small class="form-text">Set free your imagination !</small>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="historique_categorie" id="historique_categorie" value="<?= $i['historique_categorie'] ?>" class="form-control form-control-success" ><small class="form-text">Allez racontez nous l'historique!</small>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <div class="input-group">
                              <div class="input-group-prepend">
                                <img src="<?php echo $i['photo_categorie'] ?>" width="100" height="100">
